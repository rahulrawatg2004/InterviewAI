      ...
      <div className="flex-1 px-6 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-center mb-6">
            <div
              className="bg-gray-100 text-gray-600 text-lg px-4 py-2
          ...
          <div className="text-center mb-28">
            ...
            >
              Prepare smarter with realistic mock interviews, personalized
              questions, and actionable feedback tailored to your target role.
            </motion.p>
                ...
                >
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="w-full md:w-1/2">
                      <div
                        className=" lbg-green-50 ☐ text-green-600 w-12 h-12
              ...
              {[
                ...
                >
                  <div className="flex items-center justify-between gap-6">
                    <div className="w-1/2">
                      <h3 className="font-semibold text-x1 mb-3">
                        {mode.title}
                      </h3>
